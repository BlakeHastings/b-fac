...
def save_state(state, dry):
    ...
    # the resume check below tests the VALUE rather than the key, a poisoned
    # file used to turn the real run into a silent no-op that printed
    # "exists as #0" twelve times and created nothing.
    if dry:
        return
